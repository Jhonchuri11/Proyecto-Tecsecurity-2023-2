...
import com.jhon.churivanti.tsecurity.databinding.ActivityRutaBinding
...
class RutaActivity : BaseActivity<ActivityRutaBinding>(ActivityRutaBinding::inflate),
    OnMapReadyCallback {

    private lateinit var map: GoogleMap

    private var mapCamera: CameraPosition? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        // Iniciando mapfragment

        val mapFragment = supportFragmentManager.findFragmentById(R.id.fragmentMapRuta) as SupportMapFragment
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                val call = getRetrofit().create(ApiService::class.java)
                    .getRouteMovil("5b3ce3597851110001cf6248b76dc09373cd483c81252f3a4b390023", start, end)
